...
const WebhookIntegration = ({ projects, webhookIntegrations, match, auth }) => {
  ...
  return(
    <>
      ...
      {status === REQUEST.SUCCESS && (integration && project) && <WebhookIntegrationCard project={project} integration={integration} user={auth.user} />}
    </>
  )
}
...
export { ConnectedPage as WebhookIntegration };